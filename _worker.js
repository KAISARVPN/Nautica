...
<html lang="en" id="html" class="scroll-smooth dark">
  ...
  <body class="bg-neutral-900 dark:bg-black text-neutral-200 dark:text-neutral-200 selection:bg-red-700 selection:text-white">
    ...
    <div id="container-window" class="hidden fixed inset-0 z-40 bg-black/80 backdrop-blur-sm">
      <div data-aos="zoom-in" data-aos-duration="300" class="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-md p-4">
      <p id="container-window-info" class="text-center w-full text-lg font-medium text-white"></p>
        ...
        <div id="output-window" class="w-full h-full flex flex-col gap-4 text-center rounded-md hidden">
          <div class="grid grid-cols-3 gap-3">
              <button onclick="copyToClipboardAsTarget('clash')" class="p-3 rounded-lg bg-red-700 text-white font-semibold transition-all hover:bg-red-800 hover:scale-105">
                Clash
              </button>
              <button onclick="copyToClipboardAsTarget('sfa')" class="p-3 rounded-lg bg-red-700 text-white font-semibold transition-all hover:bg-red-800 hover:scale-105">
                SFA
              </button>
              <button onclick="copyToClipboardAsTarget('bfr')" class="p-3 rounded-lg bg-red-700 text-white font-semibold transition-all hover:bg-red-800 hover:scale-105">
                BFR
              </button>
          </div>
          <div class="grid grid-cols-2 gap-3">
              <button onclick="copyToClipboardAsTarget('v2ray')" class="p-3 rounded-lg bg-neutral-700 dark:bg-neutral-700 text-white dark:text-white font-semibold transition-all hover:bg-neutral-600 dark:hover:bg-neutral-600 hover:scale-105">
                V2Ray/Xray
              </button>
              <button onclick="copyToClipboardAsRaw()" class="p-3 rounded-lg bg-neutral-700 dark:bg-neutral-700 text-white dark:text-white font-semibold transition-all hover:bg-neutral-600 dark:hover:bg-neutral-600 hover:scale-105">
                Raw
              </button>
          </div>
          <div class="mt-4">
              <button onclick="toggleOutputWindow()" class="w-1/2 p-3 border-2 border-neutral-600 text-neutral-400 font-semibold rounded-lg transition-all hover:bg-neutral-600 hover:text-white">
                Close
              </button>
          </div>
        </div>
