...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    // PERUBAHAN: Judul diubah ke tema modern
    document.setTitle("Welcome to <span class='font-bold text-3xl bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent'>Nexus Proxy Hub</span>");
 ...
 *
 * PERUBAHAN v3 (MODERN THEME):
 * - Palet warna diubah menjadi biru/teal modern dengan gradien.
 * - Font judul diubah menjadi 'Poppins' dari Google Fonts untuk nuansa modern.
 * - Teks dan judul diubah agar sesuai dengan tema (cth: "Nexus Proxy Hub", "Premium Servers").
 * - Animasi AOS diubah sedikit (durasi lebih cepat, easing berbeda).
 * - Notifikasi diubah menjadi biru dengan teks "Configuration copied successfully!".
 * - Tombol-tombol diubah menjadi gradien biru/teal.
 * - Latar belakang default adalah mode terang dengan opsi dark mode.
 * - Menambahkan fitur filter negara, sorting, dan pencarian.
...
<html lang="en" id="html" class="scroll-smooth">
  <head>
    ...
    <style>
      ...
      .animated-gradient {
        background: linear-gradient(-45deg, #0ea5e9, #14b8a6, #3b82f6, #06b6d4);
  ...
  <body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 selection:bg-blue-500 selection:text-white">
      ...
      <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <div class="animated-gradient text-white p-2 rounded-lg">
    ...
    <!-- Hero Section -->
    <section class="animated-gradient text-white py-16">
      <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row items-center justify-between">
          <div class="md:w-1/2 mb-8 md:mb-0" data-aos="fade-right">
            <h2 class="text-4xl font-bold mb-4">Premium Proxy Servers</h2>
            <p class="text-xl mb-6 text-blue-100">Lightning-fast, secure, and reliable proxy connections for all your needs.</p>
      ...
      <div class="container mx-auto px-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div class="flex items-center space-x-4">
            ...
            <div class="flex flex-wrap gap-2" id="country-filters">
              <!-- Country filters will be inserted here -->
            </div>
          </div>
          
          <div class="flex items-center space-x-4">
            <div class="relative">
              <input type="text" id="search-input" placeholder="Search servers..." class="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 absolute left-3 top-2.5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </div>
            
            <select id="sort-select" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="mt-4 flex items-center justify-between">
          ...
          <div class="flex items-center space-x-2">
            <button id="refresh-btn" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors flex items-center">
      ...
      <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex space-x-6">
            <a href="#" class="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">Privacy Policy</a>
            <a href="#" class="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">Terms of Service</a>
            <a href="#" class="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">Contact</a>
          </div>
        </div>
      </div>
    </footer>
    ...
    <div class="fixed bottom-6 right-6 flex flex-col space-y-3">
      <a href="${DONATE_LINK}" target="_blank" title="Donate" class="bg-blue-500 text-white rounded-full p-3 shadow-lg hover:bg-blue-600 transition-all hover:scale-110">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      </a>
      
      <button onclick="toggleWildcardsWindow()" title="Wildcard Domains" class="bg-blue-500 text-white rounded-full p-3 shadow-lg hover:bg-blue-600 transition-all hover:scale-110 PLACEHOLDER_API_READY">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
        </svg>
      </button>
      
      <button onclick="scrollToTop()" title="Back to Top" class="bg-gray-500 text-white rounded-full p-3 shadow-lg hover:bg-gray-600 transition-all hover:scale-110">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div id="wildcards-window" class="w-full h-full flex flex-col gap-4 rounded-md hidden">
          <div class="flex w-full h-full gap-2">
            <input
              id="new-domain-input"
              type="text"
              placeholder="Input subdomain (e.g., mydomain)"
              class="flex-grow w-full h-full px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white"
            />
            <button
          ...
          <div class="h-64 rounded-md bg-gray-100 dark:bg-gray-700 p-4 overflow-y-auto">
    ...
    <script>
      ...
      function toggleCountryFilter(country) {
        ...
        // Update UI
        document.querySelectorAll('.country-filter').forEach(el => {
          if (el.getAttribute('data-country') === country) {
            el.classList.toggle('bg-blue-500');
        ...
        const res = fetch(url).then(async (res) => {
          ...
          if (res.status == 200) {
            ...
            if (respJson.length === 0) {
              domainListContainer.innerHTML = '<p class="text-center text-gray-500 dark:text-gray-400">No domains registered.</p>';
              return;
            }
            for (const domain of respJson) {
              const domainElement = document.createElement("div");
              domainElement.classList.add("p-3", "bg-gray-100", "dark:bg-gray-600", "rounded-md", "font-medium");
        ...
        const res = fetch(url).then((res) => {
          if (res.status == 200) {
            ...
            if (res.status == 409) {
              ...
              showWindowInfo("Domain contains forbidden words!");
            } else {
      ...
      function toggleWildcardsWindow() {
        showWindowInfo("Domain Management");
        toggleWindow();
...
class Document {
  ...
  buildProxyGroup() {
    ...
    if (this.proxies.length === 0) {
        ...
        for (let i = 0; i < this.proxies.length; i++) {
          ...
          proxyGroupElement += `
          <div data-aos="fade-up" data-aos-delay="${(i % 4) * 100}" class="lozad bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden" data-proxy data-country="${proxyData.country}" data-name="${proxyData.org}" data-ip="${proxyData.proxyIP}">
            <div class="p-4 border-b border-gray-100 dark:border-gray-700">
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                  <img width="32" class="rounded-full" src="https://hatscripts.github.io/circle-flags/flags/${proxyData.country.toLowerCase()}.svg" />
  ...
  buildProxyButtons(proxyList, proxyIndex) {
    ...
    for (let x = 0; x < proxyList.length; x++) {
      ...
      buttonsHTML += `<button class="bg-blue-500 text-white text-xs font-medium rounded-md p-2 w-full transition-all duration-200 hover:bg-blue-600 hover:scale-105" onclick="copyToClipboard('${proxy}')">${indexName[x]}</button>`;
    }
    return buttonsHTML;
  }
  ...
  buildCountryFlag() {
    ...
    for (const flag of new Set(flagList)) {
      ...
      flagElement += `
      <button onclick="toggleCountryFilter('${flag}')" class="country-filter px-3 py-1 rounded-full text-sm font-medium bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-blue-500 hover:text-white transition-colors" data-country="${flag}">
  ...
  addPageButton(text, link, isDisabled) {
    ...
    <li>
      <button ${isDisabled ? "disabled" : ""} 
              class="px-4 py-2 font-medium bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm transition-all hover:bg-blue-500 hover:text-white hover:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed" 
