      ...
      <div data-aos="zoom-in" data-aos-duration="300" class="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-sm p-4">
        ...
        <div id="output-window" class="w-full h-full flex flex-col gap-4 text-center rounded-md hidden">
          ...
          <div class="flex flex-wrap justify-center gap-2">
            <button onclick="copyToClipboardAsTarget('clash')" class="basis-28 p-3 rounded-lg bg-red-700 text-white font-semibold transition-all hover:bg-red-800 hover:scale-105">
              Clash
            </button>
            <button onclick="copyToClipboardAsTarget('sfa')" class="basis-28 p-3 rounded-lg bg-red-700 text-white font-semibold transition-all hover:bg-red-800 hover:scale-105">
              SFA
            </button>
            <button onclick="copyToClipboardAsTarget('bfr')" class="basis-28 p-3 rounded-lg bg-red-700 text-white font-semibold transition-all hover:bg-red-800 hover:scale-105">
              BFR
            </button>
            <button onclick="copyToClipboardAsTarget('v2ray')" class="basis-40 p-3 rounded-lg bg-neutral-700 dark:bg-neutral-700 text-white dark:text-white font-semibold transition-all hover:bg-neutral-600 dark:hover:bg-neutral-600 hover:scale-105">
              V2Ray/Xray
            </button>
            <button onclick="copyToClipboardAsRaw()" class="basis-40 p-3 rounded-lg bg-neutral-700 dark:bg-neutral-700 text-white dark:text-white font-semibold transition-all hover:bg-neutral-600 dark:hover:bg-neutral-600 hover:scale-105">
              Raw
            </button>
          </div>
          <div class="mt-4">
