...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='font-bold text-3xl bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 bg-clip-text text-transparent'>Nexus Proxy Hub</span>");
 ...
 *
 * PERUBAHAN v4 (ADVANCED MODERN THEME):
 * - Palet warna diubah menjadi gradien ungu/pink/merah yang lebih modern.
 * - Font judul diubah menjadi 'Inter' dengan gradien text.
 * - Menambahkan fitur pencarian server dengan auto-complete.
 * - Menambahkan kemampuan mengganti nama saat membuat akun.
 * - Menambahkan animasi loading yang lebih menarik.
 * - Menambahkan efek glassmorphism yang lebih baik.
 * - Menambahkan animasi hover yang lebih interaktif.
 * - Menambahkan statistik server real-time.
 * - Menambahkan filter negara yang lebih baik.
 * - Menambahkan sorting yang lebih baik.
 * - Menambahkan pagination yang lebih baik.
 * - Menambahkan notifikasi yang lebih baik.
 * - Menambahkan modal yang lebih baik.
 * - Menambahkan footer yang lebih baik.
 * - Menambahkan navigasi yang lebih baik.
 * - Menambahkan dark mode yang lebih baik.
 * - Menambahkan responsive design yang lebih baik.
 */
let baseHTML = `
<!DOCTYPE html>
<html lang="en" id="html" class="scroll-smooth">
  ...
  <body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 selection:bg-purple-500 selection:text-white">
      ...
      <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <div class="animated-gradient text-white p-2 rounded-lg float-animation">
          ...
          <div class="flex items-center space-x-4">
            ...
            <button onclick="toggleDarkMode()" class="p-2 rounded-lg bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors" title="Toggle Dark Mode">
    ...
    <!-- Hero Section -->
    <section class="animated-gradient text-white py-16 relative overflow-hidden">
      <div class="absolute inset-0 bg-black opacity-20"></div>
      <div class="container mx-auto px-6 relative z-10">
        <div class="flex flex-col md:flex-row items-center justify-between">
          <div class="md:w-1/2 mb-8 md:mb-0" data-aos="fade-right">
            <h2 class="text-4xl md:text-5xl font-bold mb-4">Premium Proxy Servers</h2>
            <p class="text-xl mb-6 text-purple-100">Lightning-fast, secure, and reliable proxy connections for all your needs.</p>
            <div class="flex flex-wrap gap-4 mb-8">
              <div class="bg-white/20 backdrop-blur-sm rounded-lg p-4 pulse-animation">
                ...
                <div class="text-sm">Active Servers</div>
              </div>
            ...
            <div class="flex flex-wrap gap-3">
              <button onclick="scrollToServers()" class="px-6 py-3 bg-white text-purple-600 font-semibold rounded-lg hover:bg-gray-100 transition-all transform hover:scale-105">
                Explore Servers
              </button>
              <button onclick="toggleWildcardsWindow()" class="px-6 py-3 bg-purple-800 text-white font-semibold rounded-lg hover:bg-purple-900 transition-all transform hover:scale-105 PLACEHOLDER_API_READY">
                Create Account
              </button>
            </div>
          </div>
          <div class="md:w-1/2" data-aos="fade-left">
            <div class="relative">
              <img src="https://picsum.photos/seed/proxy-servers/600/400.jpg" alt="Proxy Servers" class="rounded-lg shadow-2xl">
              <div class="absolute -bottom-6 -right-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 float-animation">
                <div class="flex items-center space-x-2">
                  ...
                  <span class="text-sm font-medium text-gray-800 dark:text-white">All Systems Operational</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="bg-white dark:bg-gray-800 py-8 shadow-md">
      <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto">
          <h3 class="text-2xl font-bold text-center mb-6 text-gray-800 dark:text-white">Find Your Perfect Server</h3>
          ...
          <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 shadow-lg">
            ...
            <div class="relative mb-6">
              <input 
                ...
                class="w-full pl-12 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500"
                autocomplete="off"
              >
            ...
            <div class="flex flex-wrap gap-2 mb-6">
              <button onclick="setQuickFilter('fast')" class="quick-filter px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-full text-sm font-medium hover:bg-purple-500 hover:text-white transition-all">
                ⚡ Fastest
              </button>
              <button onclick="setQuickFilter('asia')" class="quick-filter px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-full text-sm font-medium hover:bg-purple-500 hover:text-white transition-all">
                🌏 Asia
              </button>
              <button onclick="setQuickFilter('europe')" class="quick-filter px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-full text-sm font-medium hover:bg-purple-500 hover:text-white transition-all">
                🌍 Europe
              </button>
              <button onclick="setQuickFilter('america')" class="quick-filter px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-full text-sm font-medium hover:bg-purple-500 hover:text-white transition-all">
                🌎 America
              </button>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select id="protocol-select" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500">
              ...
              <div>
                ...
                <select id="security-select" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500">
              ...
              <div>
                ...
                <select id="sort-select" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500">
    ...
    <main class="container mx-auto px-6 py-8" id="servers-section">
      ...
      <section class="mb-12">
        <div class="flex items-center justify-between mb-6">
          <h3 class="text-2xl font-bold text-gray-800 dark:text-white">Available Servers</h3>
    ...
    <footer class="bg-gray-100 dark:bg-gray-800 py-12 mt-16">
      <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h4 class="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Nexus Proxy Hub</h4>
            <p class="text-gray-600 dark:text-gray-400">Premium proxy servers for all your needs. Fast, secure, and reliable.</p>
          </div>
          
          <div>
            <h4 class="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Quick Links</h4>
            <ul class="space-y-2">
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-purple-500 transition-colors">About Us</a></li>
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-purple-500 transition-colors">Pricing</a></li>
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-purple-500 transition-colors">Documentation</a></li>
            </ul>
          </div>
          
          <div>
            <h4 class="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Support</h4>
            <ul class="space-y-2">
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-purple-500 transition-colors">Help Center</a></li>
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-purple-500 transition-colors">Contact Us</a></li>
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-purple-500 transition-colors">Status</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-purple-500 transition-colors">Privacy Policy</a></li>
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-purple-500 transition-colors">Terms of Service</a></li>
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-purple-500 transition-colors">Cookie Policy</a></li>
            </ul>
          </div>
        </div>
        
        <div class="border-t border-gray-200 dark:border-gray-700 mt-8 pt-8 text-center">
          <p class="text-gray-600 dark:text-gray-400">&copy; 2025 ${serviceName}.${rootDomain}. All rights reserved.</p>
        </div>
      </div>
    </footer>
    ...
    <div class="fixed bottom-6 right-6 flex flex-col space-y-3">
      <a href="${DONATE_LINK}" target="_blank" title="Donate" class="bg-purple-500 text-white rounded-full p-3 shadow-lg hover:bg-purple-600 transition-all hover:scale-110 float-animation">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      </a>
      
      <button onclick="toggleWildcardsWindow()" title="Create Account" class="bg-purple-500 text-white rounded-full p-3 shadow-lg hover:bg-purple-600 transition-all hover:scale-110 float-animation PLACEHOLDER_API_READY" style="animation-delay: 0.5s">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
        </svg>
      </button>
      
      <button onclick="scrollToTop()" title="Back to Top" class="bg-gray-500 text-white rounded-full p-3 shadow-lg hover:bg-gray-600 transition-all hover:scale-110 float-animation" style="animation-delay: 1s">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    >
      ...
      <div>
        <div class="text-md font-bold text-green-600">Success!</div>
        <p class="text-sm text-gray-600 dark:text-gray-400">Configuration copied successfully!</p>
      </div>
    </div>
      ...
      <div data-aos="zoom-in" data-aos-duration="300" class="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-md p-6 bg-white dark:bg-gray-800 rounded-xl shadow-2xl">
        ...
        <div id="output-window" class="w-full h-full flex flex-col gap-4 text-center rounded-md hidden">
          <div class="grid grid-cols-2 gap-3">
            <button onclick="copyToClipboardAsTarget('clash')" class="p-3 rounded-lg bg-purple-500 text-white font-semibold transition-all hover:bg-purple-600 hover:scale-105">
              Clash
            </button>
            <button onclick="copyToClipboardAsTarget('sfa')" class="p-3 rounded-lg bg-purple-500 text-white font-semibold transition-all hover:bg-purple-600 hover:scale-105">
              SFA
            </button>
            <button onclick="copyToClipboardAsTarget('bfr')" class="p-3 rounded-lg bg-purple-500 text-white font-semibold transition-all hover:bg-purple-600 hover:scale-105">
              BFR
            </button>
        ...
        <div id="wildcards-window" class="w-full h-full flex flex-col gap-4 rounded-md hidden">
          <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-4">Create Your Account</h3>
          ...
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white"
              />
            </div>
            ...
            <div>
              ...
              <div class="flex w-full h-full gap-2">
                <input
                  ...
                  class="flex-grow w-full h-full px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white"
                />
            ...
            <button
              ...
              class="w-full p-3 rounded-lg bg-purple-500 text-white font-semibold transition-all hover:bg-purple-600 hover:scale-105"
            >
              Create Account
            </button>
          </div>
          ...
          <div class="border-t border-gray-200 dark:border-gray-600 pt-4">
            <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">Your Accounts</h4>
    ...
    <script>
      ...
      function getDomainList() {
        ...
        const res = fetch(url).then(async (res) => {
          ...
          if (res.status == 200) {
            windowInfoContainer.innerText = "Your Accounts";
            const respJson = await res.json();
            if (respJson.length === 0) {
              domainListContainer.innerHTML = '<p class="text-center text-gray-500 dark:text-gray-400">No accounts created yet.</p>';
              return;
            }
            for (const domain of respJson) {
              ...
              domainElement.innerHTML = \`
                <span>\${domain}</span>
                <button onclick="copyToClipboard('\${domain}')" class="text-purple-500 hover:text-purple-600">
            ...
            domainListContainer.innerHTML = '<p class="text-center text-red-500">Failed to fetch accounts.</p>';
          }
        });
      }
      ...
      function registerDomain() {
        ...
        if (!rawDomain) {
            showWindowInfo("Subdomain cannot be empty!");
            return;
        }
        
        if (!name) {
            showWindowInfo("Name cannot be empty!");
            return;
        }
        ...
        showWindowInfo("Creating account...");

        const url = "https://" + rootDomain + "/api/v1/domains/put?domain=" + domain + "&name=" + encodeURIComponent(name);
        const res = fetch(url).then((res) => {
          if (res.status == 200) {
            showWindowInfo("Account created successfully!");
            ...
            if (res.status == 409) {
              showWindowInfo("Account already exists!");
            } else if (res.status == 403) {
              showWindowInfo("Subdomain contains forbidden words!");
            } else {
      ...
      async function copyToClipboardAsTarget(target) {
        ...
        if (res.status == 200) {
          showWindowInfo("Config generated!");
      ...
      function toggleWildcardsWindow() {
        showWindowInfo("Create Your Account");
        toggleWindow();
      ...
      function checkGeoip() {
        ...
        const res = fetch("https://" + rootDomain + "/api/v1/myip").then(async (res) => {
          if (res.status == 200) {
            ...
            containerCountry.querySelector('span').textContent = "Country: " + respJson.country;
          }
        });
      }
    </script>
...
class Document {
  ...
  buildProxyGroup() {
    ...
    if (this.proxies.length === 0) {
        ...
        <div class="col-span-full text-center py-10" data-aos="fade-up">
            ...
            <h3 class="mt-4 text-xl font-semibold text-gray-600 dark:text-gray-400">No Servers Found</h3>
            <p class="mt-2 text-gray-500 dark:text-gray-500">Try changing the page or country filter.</p>
        </div>
        `;
    } else {
        for (let i = 0; i < this.proxies.length; i++) {
          ...
          proxyGroupElement += `
          <div data-aos="fade-up" data-aos-delay="${(i % 4) * 100}" class="lozad bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group" data-proxy data-country="${proxyData.country}" data-name="${proxyData.org}" data-ip="${proxyData.proxyIP}">
            <div class="p-4 border-b border-gray-100 dark:border-gray-700">
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                  <img width="32" class="rounded-full ring-2 ring-purple-500 ring-offset-2 group-hover:scale-110 transition-transform" src="https://hatscripts.github.io/circle-flags/flags/${proxyData.country.toLowerCase()}.svg" />
                  <div>
                ...
                <div id="ping-${proxyIndex}" data-target="${proxyData.proxyIP}:${proxyData.proxyPort}" class="text-xs font-semibold text-gray-500 dark:text-gray-400">Idle</div>
              </div>
            </div>
  ...
  buildProxyButtons(proxyList, proxyIndex) {
    ...
    for (let x = 0; x < proxyList.length; x++) {
      ...
      buttonsHTML += `<button class="bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-medium rounded-md p-2 w-full transition-all duration-200 hover:from-purple-600 hover:to-pink-600 hover:scale-105 hover:shadow-lg" onclick="copyToClipboard('${proxy}')">${indexName[x]}</button>`;
    }
    return buttonsHTML;
  }
  ...
  buildCountryFlag() {
    ...
    for (const flag of new Set(flagList)) {
      ...
      flagElement += `
      <button onclick="toggleCountryFilter('${flag}')" class="country-filter px-3 py-1 rounded-full text-sm font-medium bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-purple-500 hover:text-white transition-colors" data-country="${flag}">
  ...
  addPageButton(text, link, isDisabled) {
    ...
    <li>
      <button ${isDisabled ? "disabled" : ""} 
              class="px-4 py-2 font-medium bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm transition-all hover:bg-purple-500 hover:text-white hover:border-purple-500 disabled:opacity-50 disabled:cursor-not-allowed" 
